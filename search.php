	  ...
	  <div class="album py-5 bg-light">
		<div class="container">
		  ...
		  <?php
			...
			$sql = "SELECT * FROM products WHERE name LIKE '%$NomeProduto%'";
		  ...
		  ?>
			...
			<div class="col">
			  <div class="card shadow-sm">
				<img style="max-height:300px;" src="<?php echo $row['imageurl'] ?>">
				<div class="card-body">
				  ...
				  <div class="d-flex justify-content-between align-items-center">
					<div class="btn-group">
					  <a href="product.php?id=<?php echo $row['id'] ?>"><button type="button" class="btn btn-primary">Buy Now</button></a>
					</div>
				  </div>
				</div>
			  </div>
