...
<html>
	<head>
		<title>EcoStore. Sua loja de produtos sustentaveis</title>
		<meta charset="utf-8" />
		...
		<span class="close">&times;</span>
		  ...
		  <div class="card-body">
			...
			<form method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>" class="p-4 p-md-5 border rounded-3 bg-light">
			  ...
			  <div class="form-floating mb-3">
				<input type="Senha" name="Senha" value="<?php echo $articlecek['passSenhaword'];?>" class="form-control" id="floatingSenha" placeholder="Senha">
